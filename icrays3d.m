function icrays3d(T,corelat,corelon,coredep,epid,mod,p,turnpt)
% icrays3d(T,corelat,corelon,coredep,epid,mod);
%
...
for ii=1:length(corelat)-1
    ...
    xyz=line3sphere([x(1),y(1),z(1)],[x(2),y(2),z(2)],[0,0,0,(R-coredep(ii))/R],1);
    ...
    [xyzS,topS,botS]=cylindric((width/2)/rsphere,[corelon(ii) corelat(ii)],[outlon outlat],1,1);
